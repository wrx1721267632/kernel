/*************************************************************************
	...
	> Author:
	> Mail:
	> Created Time: 2016年11月02日 星期三 20时42分31秒
 ************************************************************************/
...
struct pt_regs_t {
    ...
    uint32_t eax;
    uint32_t int_no;        //中断号
    uint32_t err_code;      //错误代码有中断错误代码的中断会由(压入CPU)
...
#define IRQ1    33  // 键盘
#define IRQ2    34  // 与 IRQ9 相连, MPU-401 MD使用
#define IRQ3    35  // 串口设备
#define IRQ4    36  // 串口设备
#define IRQ5    37  // 建议声卡驱动
